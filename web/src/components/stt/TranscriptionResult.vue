  ...
  <div class="space-y-4">
    ...
    <div class="bg-white border border-neutral-200 rounded-xl p-4">
      <div class="flex items-center justify-between mb-3">
        <h4 class="text-sm font-medium text-neutral-700">转录文本</h4>
